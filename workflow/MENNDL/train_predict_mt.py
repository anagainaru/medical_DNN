...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.evaluate:
        ...
        validate(model, criterion, args)
        print("Validate time:",  time.time() - end)
        return
...
def validate_batch(model, images, target, metrics, criterion, args):
    ...
    metrics["top1"].update(acc1[0], images.size(0))
    metrics["top5"].update(acc5[0], images.size(0))
...
def validate(model, criterion, args):
    ...
    print("Classification time:", class_total_time)
    return top1.avg
